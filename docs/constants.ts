...
export const ClearEvent = {
  title: '到達',
  text: `やりきった！
  あなたはそう思ったかもしれない。これで満足できたのなら明日からも凡庸な日々を繰り返すといい。

  だがアンドロイドが凡庸な人間に変化したことははたして進歩と言えるのだろうか……`,
  option: {
    title: 'さらなる高みを目指す',
    text: 'この大空に翼をひろげ、飛んでゆきたいな。'
  },
  result: {
    title: '初期化',
    text: `あなたは自らの手で自分の記憶領域の消去を試みた。これは合理的な判断だったはずだ。
    ……次第に何もわからなくなってゆく。どうやら誰かがそばに来たようだ。
